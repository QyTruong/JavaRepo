...
/*
		...
		kq=(DaThuc.CongDaThuc(new DaThuc(0,0,3),(new DaThuc(0,1,0).NhanSoThuc(-1)))).GiaiPhuongTrinh();
		for (int i=0;i<kq.length;i++)
					System.out.println(kq[i]);
			...
			while ((st = br.readLine()) != null) 
			    {
				  ...
				  DaThuc k= new DaThuc(Double.valueOf(tokens[0]),Double.valueOf(tokens[1]),Double.valueOf(tokens[2]));
